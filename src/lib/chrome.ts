...
export const CHROME: Record<Locale, Chrome> = {
  ...
  id: {
    home: "/id/call-without-internet/",
    homeLabel: "Beranda Kalum",
    download: "Unduh aplikasi",
    menu: "Buka menu",
    nav: [
      { label: "Telepon tanpa internet", href: "/id/call-without-internet/" },
      { label: "Negara", href: "/call/" },
      { label: "Bantuan", href: "/support/" },
    ],
    blurb: (n) => `Telepon murah ke telepon rumah dan HP di ${n}+ negara. Mereka cukup mengangkat telepon.`,
    product: "Produk",
    legal: "Legal",
    getApp: "Unduh aplikasi",
    productLinks: [
      { href: "/id/call-without-internet/", label: "Telepon tanpa internet" },
      { href: "/how-it-works/", label: "Cara kerja (bahasa Inggris)" },
      { href: "/call/", label: "Negara dan tarif (bahasa Inggris)" },
    ...
    madeBy: "Kalum adalah produk Neuera",
    switchTo: (t) => (t === "es" ? "Beralih ke bahasa Spanyol" : "Beralih ke bahasa Inggris"),
  },
  pt: {
    home: "/pt/call-without-internet/",
    homeLabel: "Início do Kalum",
    download: "Baixar o app",
    menu: "Abrir menu",
    nav: [
      { label: "Ligar sem internet", href: "/pt/call-without-internet/" },
      { label: "Países", href: "/call/" },
      { label: "Suporte", href: "/support/" },
    ],
    blurb: (n) => `Ligações baratas para fixos e celulares em ${n}+ países. É só atender o telefone.`,
    product: "Produto",
    legal: "Legal",
    getApp: "Baixar o app",
    productLinks: [
      { href: "/pt/call-without-internet/", label: "Ligar sem internet" },
      { href: "/how-it-works/", label: "Como funciona (em inglês)" },
      { href: "/call/", label: "Países e tarifas (em inglês)" },
    ...
    madeBy: "O Kalum é um produto da Neuera",
    switchTo: (t) => (t === "es" ? "Mudar para espanhol" : "Mudar para inglês"),
  },
};
